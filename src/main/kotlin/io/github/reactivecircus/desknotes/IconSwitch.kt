...
fun IconSwitch(
    ...
    val minBound = 0f
    val maxBound = with(AmbientDensity.current) { (sizes.trackWidth - sizes.thumbDiameter).toPx() }
...
private fun BoxScope.SwitchImpl(
    ...
    val hasInteraction = Interaction.Pressed in interactionState || Interaction.Dragged in interactionState
